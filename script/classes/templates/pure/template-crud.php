        ...
        <div class="page-title clearfix panel-heading pdocrud-table-heading">
            ...
            <?php if ($settings["addbtn"]) { ?>
                <div class="btn-group pull-right">
                    <a title="<?php echo $lang["add"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-add btn btn-success text-white" href="javascript:;" data-action="add" data-obj-key="<?php echo $objKey; ?>">
