<div class="col-md-12 card-wrapper" style="width: 100%;margin:auto;padding-left:10%;padding-right: 10%;padding-top: 30px;padding-bottom: 30px">
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="ค้นหา..." class="form-control">
</div>
