        ...
        <tr>
            <td>                       
                <div class="pdocrud-action-buttons pdocrud-print-hide">
                    ...
                    <button data-action="print" class="btn btn-success pdocrud-form-control pdocrud-button pdocrud-view-print" type="button"><?php echo $lang["print"] ?></button>
                    <?php } ?>
            ...
            <td class="text-right">                        
                <div class="pdocrud-action-buttons pdocrud-button-delete">
                    ...
                    <?php if (isset($settings["viewBackButton"]) && $settings["viewBackButton"] === true) { ?>
                     <button data-action="back" data-dismiss="modal" class="btn btn-danger pdocrud-form-control pdocrud-button pdocrud-back" type="button"><?php echo $lang["back"] ?></button>
                    <?php } ?>
                </div>                         
            </td>
        </tr>
