<div class="input-group" style="width: 100%;margin:auto;padding-left:10%;padding-right: 10%;padding-top: 30px;padding-bottom: 30px">
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="ค้นหา..." class="form-control"><?php if ($settings["addbtn"]) { ?>
                
                
                <span class="input-group-btn">
                                <button class="btn btn-success text-white" type="button"><a title="<?php echo $lang["add"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-add text-white" href="javascript:;" data-action="add" data-obj-key="<?php echo $objKey; ?>" style="color:#fff">
...
<div class="table-responsive">
    <table id="myTable" class="table pdocrud-table table-bordered table-striped table-condensed" data-obj-key="<?php echo $objKey; ?>" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
